const styles = {
  ...
  price: "font-[500] text-[13px] text-[#d55b45] pl-3 mt-[-4px] line-through",
  ...
  cart_button:
    "px-[15px] sm:px-[20px] h-[38px] rounded-[10px] sm:rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer",
  cart_button_text: "text-[#fff] text-[13px] sm:text-[16px] font-[600]",
