      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@shop0.com with your order number and a brief
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@myecommercestore.com, or by calling us at (254)
                742-275-513 between the hours of 9am and 5pm EAT, Monday through
                Friday.
              </p>
            </div>
          )}
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within the East Africa.
              </p>
            </div>
          )}
        </div>
